...
//SafeAreaView ele faz o padding da statusbar e do padding
...
const Detail = () => {
    ...
    //para pegar os parametros vindo pela rota
    const route = useRoute();

    //route.params as Params - com isso typescript sabe que o route.params é do tipo Params
    ...
    // se data.point não existe retone
    if (!data.point) {
        return null;
    }
